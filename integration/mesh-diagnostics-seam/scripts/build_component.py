...
Hatchling and build installed, and running bun install --frozen-lockfile at the repository root.
"""
...
preview = Path(subprocess.check_output(
    ["node", "--input-type=module", "-e",
     "console.log(import.meta.resolve('@gradio/preview'))"],
    cwd=root, text=True,
).strip().removeprefix("file://"))
