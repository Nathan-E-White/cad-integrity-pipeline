...
export default defineConfig({testDir:'tests/browser',workers:1,timeout:60000,
 ...
 webServer:{command:'CAD_INTEGRITY_PREVIEW_PORT=7864 CAD_INTEGRITY_REQUIRE_CLEAN=1 pixi run inspection-preview',cwd:'../../..',url:'http://127.0.0.1:7864',reuseExistingServer:false,timeout:60000},
});
