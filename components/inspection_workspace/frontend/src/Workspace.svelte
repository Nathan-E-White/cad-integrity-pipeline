...
<style>input[type=checkbox]{appearance:auto;width:14px;height:14px;accent-color:#475569}.toolbar{display:flex;flex-wrap:wrap;align-items:center;gap:12px;margin:8px 0;font-size:13px}.toolbar label{display:flex;gap:5px;align-items:center}.toolbar input[type=number]{width:90px}.panes{display:grid;grid-template-columns:1fr 1fr;gap:8px}.panes.maximized{grid-template-columns:1fr}.pane{min-width:0;border:1px solid #94a3b866}.pane.active{border-color:#64748b}.concealed{display:none}.vacant{height:460px}header{display:flex;justify-content:space-between;padding:4px 8px}button{cursor:pointer}.tables{display:grid;grid-template-columns:minmax(200px,1fr) 2fr;gap:24px;margin-top:16px}</style>
